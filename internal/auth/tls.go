...
// Verifies the peer certificates on the TLS handshake for one that stricly matches a previously shared
// pinned certificate. We use it to verify ephemereal certificates exchanged through a side channel.
